                  ...
                  <div class="modal-body">
                    ...
                    <div class="row">
                      <div class="col-md-6 mb-3">
                        <div class="row">
                          <div class="col-4">
                            <img src="{{ asset('images/files.svg') }}" width="40px" />
                          </div>
                          <div class="col-8">
                            <a class="text-decoration-none" href="{{ route('download') }}?file=/uploads/${full.ic_front.name}.${full.ic_front.ext}">
                      ...
                      <div class="col-md-6 mb-3">
                        <div class="row">
                          ...
                          <div class="col-8">
                            <a class="text-decoration-none" href="{{ route('download') }}?file=/uploads/${full.ic_back.name}.${full.ic_back.ext}">
                      ...
                      <div class="col-md-6 mb-3">
                        <div class="row">
                          ...
                          <div class="col-8">
                            <a class="text-decoration-none" href="{{ route('download') }}?file=/uploads/${full.salary.name}.${full.salary.ext}">
                      ...
                      <div class="col-md-6 mb-3">
                        <div class="row">
                          ...
                          <div class="col-8">
                            <a class="text-decoration-none" href="{{ route('download') }}?file=/uploads/${full.salary_slip.name}.${full.salary_slip.ext}">
